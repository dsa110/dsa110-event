...
def send_ctd(triggerfile, doi=None, filenames=[], production=False, schema='43'):
    ...
    # write metadata
    res = caltechdata_write(metadata, token, production=production, schema=schema)
...
#                                             'alternateIdentifierType': '?'}]
    ...
    doi = get_doi(metadata, doi=doi)  # TODO: check whether it is returned or just added to metadata dict
