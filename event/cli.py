...
@click.option('--propdays', type=str, default=None)
def tns_create(inname, send, production, repeater_of_objid, remarks, propdate, propdays):
    ...
    propdays is number of days to wait to make public.
    """
